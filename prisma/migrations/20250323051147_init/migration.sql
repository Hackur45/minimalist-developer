...
-- CreateTable
CREATE TABLE "BackgroundRemoval" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "prompt" TEXT,
    "imageData" TEXT NOT NULL,
    ...
    CONSTRAINT "BackgroundRemoval_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "BackgroundRemoval" ADD CONSTRAINT "BackgroundRemoval_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
